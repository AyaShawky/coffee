                    ...
                    <div class="col-md-4 mt-4">
                        <div class="box-sale p-3 text-center mt-5">
                            ...
                            <div class="NotoRegular w-75 mx-auto text-offer">
                                ملاحظة : يمكنك الدفع يدويا من خلال مكتبنا أو الدفع إلكترونيا من خلال جوال باي
                            </div>
                            <div class="link d-flex">
                                <a href="{{route('front.apply',$course->id)}}" class="text-decoration-none btn-primary text-white NotoRegular p-3 w-100">
تقديم الطلب و الدفع من خلال المقر                                  </a>
                            </div>

                            <br>
                            <div class="link d-flex">
                                <a href="{{route('auth',$course->id)}}" class="text-decoration-none btn-primary text-white NotoRegular p-3 w-100">
                                    تقديم الطلب والدفع من خلال  جوال باي
                                </a>
                            </div>
