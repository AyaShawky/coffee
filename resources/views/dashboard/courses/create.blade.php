                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="preview_video" name="preview_video" type="text" value="{{old('preview_video')}}" class="form-control input-xlarge">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="preview_video" name="price" type="number" value="{{old('price')}}" class="form-control input-xlarge">
                                            </div>
                                        </div>
                                    </div>
